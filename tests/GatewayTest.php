...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Payplus\Message\CreditCardRequest', $request);
    ...
    public function testCompleteAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Payplus\Message\TransactionReferenceRequest', $request);
    ...
    public function testUpdateCard()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Payplus\Message\CardReferenceRequest', $request);
